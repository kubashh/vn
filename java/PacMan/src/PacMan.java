...
public class PacMan extends JPanel implements ActionListener, KeyListener {
  class Block {
    ...
    void updateVelocity() {
      if(this.direction == 'U') {
        this.velocityX = 0;
        this.velocityY = -Consts.tileSize / 4;
      } else if(this.direction == 'D') {
        this.velocityX = 0;
        this.velocityY = Consts.tileSize / 4;
      } else if(this.direction == 'L') {
        this.velocityX = -Consts.tileSize / 4;
        this.velocityY = 0;
  ...
  private int rowCount = Consts.rowCount;
  private int columnCount = Consts.columnCount;
  private int tileSize = Consts.tileSize;
  ...
  PacMan() {
    setPreferredSize(new Dimension(Consts.boardWidth, Consts.boardHeight));
  ...
  void Move() {
    ...
    for(Block ghost : ghosts) {
      ...
      // check wall collisions
      for(Block wall : walls) {
        if(Collision(ghost, wall) || ghost.x < 0 || ghost.x + ghost.width >= Consts.boardWidth) {
          ghost.x -= ghost.velocityX;
          ghost.y -= ghost.velocityY;
